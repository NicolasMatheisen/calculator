	...
	if ($action === "clear") {
		...
		*/
		...
		if (isset($_SESSION["result"]) && isset($_SESSION["operator"])) {
			if (isset($_SESSION["operatorSymbol"]) && strpos($_SESSION["display"], $_SESSION["operatorSymbol"]) !== false) {
				$parts = explode($_SESSION["operatorSymbol"], $_SESSION["display"], 2);
	...
	<main class="calculator">
		<form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
			...
			<div class="calculatorKeys">
				<button class="button buttonFunction lightgrey black" type="submit" name="action"
					value="clear">AC</button>
				<button class="button buttonFunction lightgrey black" type="submit" name="action"
					value="negate">+/-</button>
				<button class="button buttonFunction lightgrey black" type="submit" name="action"
					value="percent">%</button>
				...
				<button class="button buttonOperator orange white" type="submit" name="action"
					value="multiply">x</button>
